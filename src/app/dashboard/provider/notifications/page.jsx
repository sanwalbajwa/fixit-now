...
const TONE = {
  success: {
    bg:    'bg-[#009689]/5',
    border:'border-[#009689]/25',
    icon:  <CheckCircle2  className="size-5 text-[#009689]" />,
    pill:  'bg-[#009689]/10 text-[#009689]',
    label: 'Success',
  },
  warning: {
    bg:    'bg-[#f97c66]/5',
    border:'border-[#f97c66]/25',
    icon:  <AlertTriangle className="size-5 text-[#f97c66]" />,
    pill:  'bg-[#f97c66]/10 text-[#f97c66]',
    label: 'Warning',
  },
  danger: {
    bg:    'bg-rose-50',
  ...
  info: {
    ...
    icon:  <Info          className="size-5 text-[#009689]" />,
    pill:  'bg-[#009689]/10 text-[#009689]',
    label: 'Info',
  },
}

function getT(tone) { return TONE[tone] || TONE.info }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        ...
        {unread > 0 && (
          <div className="inline-flex items-center gap-0 rounded-full border border-slate-200 bg-white shadow-sm overflow-hidden">
            <span className="flex items-center gap-1.5 bg-[#009689]/10 px-3 py-1 text-xs font-semibold text-[#009689]">
              <Bell className="size-3.5" />
              {unread} new
            </span>
            <span className="flex items-center gap-1.5 bg-[#f97c66]/10 px-3 py-1 text-xs font-semibold text-[#f97c66]">
              unread
            </span>
          </div>
        )}
                ...
                <div className="flex-1 min-w-0 space-y-1">
                  ...
                  <div className="flex items-center justify-between gap-3 pt-1">
                    ...
                    {item.href && (
                      <Link
                        href={item.href}
                        className="inline-flex items-center gap-1 text-xs font-semibold text-[#009689] hover:text-[#007a6e]"
                      >
